...
function ProjectRow({
	...
	const taskCountBadges: TaskCountBadge[] = [
		...
		},
		{
			...
			title: "Design",
			shortLabel: "D",
			toneClassName: "bg-text-secondary/15 text-text-secondary",
			count: project.taskCounts.design,
		},
		{
			id: "in_progress",
			title: "Building",
		...
		},
		{
			...
			title: "QA",
			shortLabel: "QA",
			toneClassName: "bg-status-yellow/20 text-status-yellow",
			count: project.taskCounts.qa,
		},
		{
			id: "shipped",
			title: "Shipped",
			...
			count: project.taskCounts.shipped,
		},
		{
			id: "trash",
			title: "Trash",
