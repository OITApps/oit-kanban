		...
		projects: [
			{
				...
				name: "project-a",
				path: "/tmp/project-a",
				taskCounts: { backlog: 1, design: 0, in_progress: 0, review: 1, qa: 0, shipped: 0, trash: 0 },
			},
			{
				id: "project-b",
				name: "project-b",
				path: "/tmp/project-b",
				taskCounts: { backlog: 0, design: 0, in_progress: 0, review: 0, qa: 0, shipped: 0, trash: 0 },
			},
		],
